   ...
   GameState initialState, const ForwardModel& /*forwardModel*/, Timer /*timer*/)
{
   ...
   */
   parameters_.heuristic = std::make_unique< DefensiveHeuristic >(initialState, getPlayerID());
...
ActionAssignment DefensiveAgent::computeAction(
